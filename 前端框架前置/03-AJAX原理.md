...
3. 学习 XHR 也是了解 axios 内部与服务器交互过程的真正原理
   ...
   ![image-20230221182835545](assets/image-20230221182835545-20231205173146-b188ju4.png)
4. 语法如下：
   ...
   ![image-20230221183057392](assets/image-20230221183057392-20231205173146-azt3q2h.png)
...
4. 需求：查询河北省下属的城市列表
   ...
   ![image-20230404133429378](assets/image-20230404133429378-20231205173146-csasgb0.png)
5. 核心代码如下：
...
1. 需求：和我们之前做的类似，就是不用 axios 而是用 XHR 实现，输入省份和城市名字后，点击查询，传递多对查询参数并获取地区列表的需求
   ...
   ![image-20230221184135458](assets/image-20230221184135458-20231205173146-3v99s3n.png)
...
2. 需求：通过 XHR 完成注册用户功能
   ...
   ![image-20230404135245271](assets/image-20230404135245271-20231205173146-n5u4h5q.png)
3. 步骤和语法：
...
2. Promise 的好处是什么？
   ...
   * 了解 axios 函数内部运作的机制
     ...
     ![image-20230222113651404](assets/image-20230222113651404-20231205173146-rl8796w.png)
...
3. Promise 的状态改变有什么用：调用对应函数，改变 Promise 对象状态后，内部触发对应回调函数传参并执行
   ...
   ![image-20230222120815484](assets/image-20230222120815484-20231205173146-tz71noy.png)
...
2. 需求：使用 Promise 和 XHR 请求省份列表数据并展示到页面上
   ...
   ![image-20230404140252181](assets/image-20230404140252181-20231205173146-p7k5a7b.png)
3. 步骤：
...
1. 需求：基于 Promise 和 XHR 封装 myAxios 函数，获取省份列表展示到页面
   ...
   ![image-20230222130217597](assets/image-20230222130217597-20231205173146-puf8na0.png)
2. 核心语法：
...
1. 需求：介绍本项目要完成的效果，和要实现的步骤和分的步骤和视频
   ...
   ![image-20230222133327806](assets/image-20230222133327806-20231205173146-qwwl8i1.png)
2. 步骤
...
1. 介绍本视频要完成的效果：搜索匹配关键字相关城市名字，展示城市列表即可
   ...
   ![image-20230222133553010](assets/image-20230222133553010-20231205173146-0iy0rge.png)
2. 步骤
...
1. 介绍本视频要完成的效果：点击城市列表名字，切换当前页面天气数据
   ...
   ![image-20230222134653884](assets/image-20230222134653884-20231205173146-mo2iltn.png)
2. 步骤
